...
const filePath = path.join(__dirname, 'src/app/onboarding/components/Step4.tsx');
...
const replacements = {
  ...
  'bg-indigo-500/10': 'bg-[var(--brand-50)]',
  ...
  'hover:bg-indigo-600': 'hover:bg-[var(--brand-600)]',
...
console.log('Step4 replacements complete');
