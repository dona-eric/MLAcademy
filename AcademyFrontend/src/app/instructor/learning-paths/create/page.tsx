...
export default function CreateLearningPathPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const path = await fetchApi("/api/private/instructor/learning-paths/", {
        method: "POST",
        body: payload,
      });
    ...
    <div className="min-h-screen bg-[#090C14] text-white p-6 lg:p-12 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto space-y-10 relative z-10 animate-in fade-in duration-700">
        ...
        <div className="flex items-center justify-between">
          <Link href="/instructor" className="flex items-center gap-2 text-slate-500 hover:text-white transition-colors font-bold text-sm">
