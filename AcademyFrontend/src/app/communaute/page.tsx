...
import { 
  Users, Briefcase, Search, Filter, ArrowRight, 
  Sparkles, Globe, MapPin, Award, Zap, 
  ChevronRight, Star, Building2, Clock, DollarSign,
  Loader2, ExternalLink, Mail, MessageSquare
} from "lucide-react";
                     ...
                     {talents.map((talent) => (
                        <div key={talent.id} className="glass-card rounded-[32px] p-8 border border-white/5 hover:border-indigo-500/30 transition-all group flex flex-col justify-between">
                           ...
                           <div className="mt-8 pt-6 border-t border-white/5 flex items-center justify-between">
                              ...
                              <button className="flex items-center gap-2 text-[10px] font-black uppercase text-indigo-400 hover:text-indigo-300 tracking-widest transition-all group-hover:translate-x-1">
                     ...
                     <div className="bg-white/5 rounded-[40px] border border-white/5 overflow-hidden">
                        ...
                        <div className="divide-y divide-white/5">
                           {leaderboard.map((talent, index) => (
                              <div key={talent.id} className="p-8 flex items-center justify-between hover:bg-white/[0.02] transition-colors group">
